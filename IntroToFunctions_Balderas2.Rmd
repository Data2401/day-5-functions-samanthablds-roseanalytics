...
# 1) Median of a group of numbers
...
# 3) Sample from a vector (pick 3 values at random)
set.seed(2401)   # makes the random sample reproducible for grading
sample(nums, size = 3)

# 4) Paste strings together (and customize the separator)
paste("Numbers", "numb", sep = " — ")

# Another example: no separator at all
paste0("DATA", "2401")
```
